<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Allaccountsplans.aspx.cs"
    Inherits="Telecom_Team_30.Allaccountsplans" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Accounts & Subscribed Plans</title>
  ...
  <style>
    ...
    .container-custom {
      ...
      margin:40px auto; max-width:1000px; box-shadow:0 4px 8px rgba(0,0,0,0.1);
    }
...
<body>
  <form runat="server">
    <div class="container-custom">
      <h2>All Accounts with Subscribed Plans</h2>
