<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TicketAccountCustomer.aspx.cs" Inherits="Telecom_Team_30.TicketAccountCustomer" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Open Tickets Count</title>
...
<body>
  <form runat="server">
    <div class="container-custom">
      <h2>Open Tickets Count</h2>
      <asp:Label ID="Label1" runat="server" CssClass="alert alert-info" /><br/>
