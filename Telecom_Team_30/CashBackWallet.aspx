<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBackWallet.aspx.cs"
    Inherits="Telecom_Team_30.CashBackWallet" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Cashback Transactions Count</title>
  ...
  <style>
    ...
    .container-custom {
      ...
      margin:40px auto; max-width:600px; box-shadow:0 4px 8px rgba(0,0,0,0.1);
    }
