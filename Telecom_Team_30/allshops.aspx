<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="allshops.aspx.cs" Inherits="Telecom_Team_30.allshops" %>
<!DOCTYPE html>
...
<head runat="server">
  ...
  <style>
    ...
    .container-custom {
      background:#E0E0E2; padding:30px; border-radius:8px;
      max-width:900px; margin:40px auto; box-shadow:0 4px 8px rgba(0,0,0,0.1);
    }
    h2.section {
      color:#364156; border-bottom:2px solid #364156;
